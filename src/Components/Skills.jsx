    ...
    return (
        ...
        <>
            <div className='w-full max-w-[2000px] px-20 md:px-4'>
                <h1 className='text-brown text-[50px] mt-9 flex md:text-[40px] md:leading-none md:overflow-hidden'>SKILLS <span className='block w-1/2 border-b-4 relative bottom-9 left-6 md:left-2 md:bottom-4 md:w-3/4'></span></h1>
                ...
                <div className='flex flex-col w-full gap-y-9'>
                    <div className='w-full bg-shadow p-6 pt-5 md:p-4'>
